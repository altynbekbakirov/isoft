...
class SafeTransactionsPage extends StatefulWidget {
  const SafeTransactionsPage({Key? key}) : super(key: key);

  @override
  State<SafeTransactionsPage> createState() => _SafeTransactionsPageState();
}

class _SafeTransactionsPageState extends State<SafeTransactionsPage> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(translation(context).safe_transactions),
          actions: [
            IconButton(
                onPressed: () {
