...
class ProductsTransactionsPage extends StatefulWidget {
  const ProductsTransactionsPage({Key? key}) : super(key: key);

  @override
  State<ProductsTransactionsPage> createState() =>
      _ProductsTransactionsPageState();
}

class _ProductsTransactionsPageState extends State<ProductsTransactionsPage> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(translation(context).product_transactions),
          actions: [
            IconButton(
                onPressed: () {
